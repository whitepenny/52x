...
function ftx_add_image_size( $name, $width, $height, $crop = false ) {
...
function ftx_get_image( $image, $size ) {
...
function ftx_responsive_image( $images, $class = '', $alt = '', $echo = true ) {
...
function ftx_get_image_orientation( $image_id ) {
...
function ftx_check_image_size( $image_id, $image_crop, $min_width = 0, $min_height = 0 ) {
  $details = ftx_get_image( $image_id, $image_crop );
...
function ftx_image_media_element( $image_id ) {
  $wide_xsmall = ftx_get_image( $image_id, 'wide-xsmall' );
  $wide_small  = ftx_get_image( $image_id, 'wide-small' );
  $wide_medium = ftx_get_image( $image_id, 'wide-medium' );
  $wide_large  = ftx_get_image( $image_id, 'wide-large' );
...
function ftx_image_media_element_small( $image_id ) {
  $wide_xsmall = ftx_get_image( $image_id, 'wide-xsmall' );
  $wide_small  = ftx_get_image( $image_id, 'wide-small' );
...
function ftx_image_team_grid( $image_id ) {
  $tall_medium = ftx_get_image( $image_id, 'tall-medium' );
...
function ftx_image_team_bio( $image_id ) {
  $square_large   = ftx_get_image( $image_id, 'square-large' );
  $standard_small = ftx_get_image( $image_id, 'standard-small' );
  $tall_xsmall    = ftx_get_image( $image_id, 'tall-xsmall' );
  $tall_small     = ftx_get_image( $image_id, 'tall-small' );
  $tall_medium    = ftx_get_image( $image_id, 'tall-medium' );
...
function ftx_image_link_block( $image_id ) {
  $square_large = ftx_get_image( $image_id, 'square-large' );
  $wide_small   = ftx_get_image( $image_id, 'wide-small' );
  $tall_medium  = ftx_get_image( $image_id, 'tall-medium' );
...
function ftx_image_background_page_header( $image_id ) {
  $square_large    = ftx_get_image( $image_id, 'square-large' );
  $square_xlarge   = ftx_get_image( $image_id, 'square-xlarge' );
  $standard_medium = ftx_get_image( $image_id, 'standard-medium' );
  $standard_large  = ftx_get_image( $image_id, 'standard-large' );
